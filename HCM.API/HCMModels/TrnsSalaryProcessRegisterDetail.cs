...
{
    public partial class TrnsSalaryProcessRegisterDetail
    {
        ...
        public string A1indicators { get; set; }
        ...
        public bool? FlgIncentivePaid { get; set; }
        public int? LogId { get; set; }
        public string DisburseType { get; set; }

        public virtual TrnsSalaryProcessRegister Sr { get; set; }
    }
}
